...
# 路径与模型环境变量
# ---------------------------------------------------------------------------
PRODUCT_CATALOG_PATH = Path(os.environ.get("PRODUCT_CATALOG_PATH", "data/catalog.jsonl"))
BLAIR_OFFLINE_EMBEDDING_PATH = Path(
    os.environ.get("BLAIR_OFFLINE_EMBEDDING_PATH", "data/offline_blair_embeds.npy")
)
...
QUERY_REWRITE_ENABLE = os.environ.get("QUERY_REWRITE_ENABLE", "false").strip().lower() in {
    "1",
    "true",
    "yes",
    "on",
